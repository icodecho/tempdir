/*
cron 30 9,10,11,13,15,17 * * * ksjsb_0509_5W.js
2022.05.09更新
IOS/安卓： 快手极速版稳定明文防黑版
...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://127.0.0.1/",//邀请信息
    ksjsbjk = "https://ghproxy.com/https://raw.githubusercontent.com/icodecho/tempdir/main/run/ksjsb-ziye.json",//广告json
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "https://127.0.0.1/";//邀请信息
