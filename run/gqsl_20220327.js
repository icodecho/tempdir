 ...
 * [task_local]
 * #腾讯自选股
 * 屏蔽0 0 屏蔽7 * * ? https://raw.githubusercontent.com/FengYun27/YunFeng_Repo/main/other/gq屏蔽sl.js, tag=广汽三菱, enabled=true
 * [rewrite_local]
...
const CommentArr = ['赞赞赞', 'nice👍', '每日签到', '👍👍👍','赞赞👍','赞👍👍👍','每日回个帖','回帖赚积分','赚个积分','赚积分哈','每日回帖','签到有积分','嗯嗯','我就回个帖','顶一下','👍👍👍👍👍👍','赞👍','嗯', '早上好', '早上好！', '早上呀！', '上午好', '上午好！', '上午呀！']
const QA_Arr = ['嗯嗯', '嗯', '百度一下哈', '没有遇到过', '喔喔', '希望专业人员能帮你解答', '希望专业老师帮你解答下', '暂没有遇到', '早上好', '早上好！', '早上呀！', '上午好', '上午好！', '上午呀！']
